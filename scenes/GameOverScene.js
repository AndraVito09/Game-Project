export default class GameOverScene extends Phaser.Scene{
    ...
    create(){
        ...
        // Shadow panel
        this.add.rectangle(cx + 6, cy + 6, panelW, panelH, 0x000000, 0.5)
            .setDepth(1);
        ...
        // Garis dekorasi atas
        this.add.rectangle(cx, cy - panelH / 2 + 6, panelW, 6, 0xff4444)
            .setDepth(3);
 
        // ── Ikon / Simbol ──────────────────────────────────────
        this.add.text(cx, cy - panelH * 0.32, '💀', {
            fontSize: fs(52)
        }).setOrigin(0.5).setDepth(3);
 
        // ── Judul ─────────────────────────────────────────────
        this.add.text(cx, cy - panelH * 0.14, 'GAME OVER', {
        ...
        // ── Info level ─────────────────────────────────────────
        this.add.text(cx, cy + panelH * 0.02, `Level ${this.level}`, {
        ...
        // ── Divider ────────────────────────────────────────────
        this.add.rectangle(cx, cy + panelH * 0.13, panelW * 0.7, 2, 0x444466)
            .setDepth(3);
    ...
    // ── Helper buat tombol dengan hover & press effect ─────────
